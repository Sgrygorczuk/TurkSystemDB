...
and other notifications instead of using postal mail, email, or voicemail.''')
	...
	project1.new_project(client_id = client1.get_id(), client_rating = 3, team_rating = 4, title = "Hello", desc = "I have a lot of money", deadline = later, bid_end_date = later, team_id = 1)
	project2.new_project(client_id = client2.get_id(), client_rating = 2, team_rating = 3, title = "World", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later, team_id = 1)
	project3.new_project(client_id = client3.get_id(), client_rating = 4, team_rating = 2, title = "Goodbye", desc = "I have more money than the other guy", deadline = later, bid_end_date = later, team_id = 1)
	project4.new_project(client_id = client4.get_id(), client_rating = 3, team_rating = 4, title = "VR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later, team_id = 1)
	project5.new_project(client_id = client4.get_id(), status = "active", title = "Cow", desc = "Moo", deadline = later, bid_end_date = later, team_id = 1)
